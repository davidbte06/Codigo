  ...
  (function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      if (document.getElementById("mapa")) {
        var map = L.map("mapa").setView([16.754516, -93.142787], 17);
      ...
      var botonRegistros = document.getElementById("btnRegistro");
